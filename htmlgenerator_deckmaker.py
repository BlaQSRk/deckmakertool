...
''' 
TODO: Change the format so that python exports the pokemon cards as a list or a data structure then zip that data for 
saving, and unpack it for use. This way you can continue where you left off, and also to allow for sorting to happen. 
Also look into classes to see if these might help:
Card properties etc
